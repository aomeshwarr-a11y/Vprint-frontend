          ...
          {currentLocations.map((location) => (
            <div className="location-card" key={location.id}>
              ...
              <div className="location-content">
                ...
                <div className="location-footer border-top pt-4 d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center gap-2">
                    <div className="bg-light p-2 rounded-3 text-primary">
                      <FaUserFriends />
                    </div>
                    <div>
                      <small className="text-muted d-block" style={{ fontSize: '10px' }}>STRENGTH</small>
                      <h5 className="mb-0 fw-bold">{location.students}</h5>
                    </div>
                  </div>
                  ...
                  {location.status === "Available" ? (
                    ...
                    <button className="btn btn-light disabled text-muted fw-bold rounded-3 px-4 py-2 border-0" disabled>
                      {location.status}
                    </button>
                  )}
                </div>
